...
RESULT_OPTIONAL = {
    ...
    "fusion_legal_group_count": (int, True),
    "fusion_installed_group_count": (int, True),
    "fusion_installed_stage_count": (int, True),
    "fusion_inverse_installed_group_count": (int, True),
    "fusion_inverse_installed_stage_count": (int, True),
    "fusion_fallback_reason": (str, True),
    "fusion_groups": (list, True),
    "fusion_inverse_groups": (list, True),
